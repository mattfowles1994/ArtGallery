...
class Artwork(models.Model):
        ...
        price = models.DecimalField(decimal_places=2, max_digits=1000, validators=[MinValueValidator(1)])
        ...
        year = models.IntegerField(default='0', validators=[MinValueValidator(1)])
